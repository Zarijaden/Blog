...
- [ProtonVPN](https://protonapps.com/protonvpn-android) [Github仓库直达链接](https://github.com/ProtonVPN/android-app/releases)（因为其实在网站里找也是导航到github）
  ...
  <br>**缺点**：无法自主选择节点。
- [v2rayNG](https://github.com/2dust/v2rayNG/releases) [小备份](https://gh-proxy.org/https://github.com/2dust/v2rayNG/releases/download/2.3.2/v2rayNG_2.3.2_universal.apk)
...
{% callout type="danger" icon="fa-solid fa-triangle-exclamation" %}
真的不要轻易尝试用国内的邮箱或者手机号去攀爬梯子！
{% endcallout %}
